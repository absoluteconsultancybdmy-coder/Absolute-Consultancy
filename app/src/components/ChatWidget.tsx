  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[100] w-14 h-14 rounded-full flex items-center justify-center shadow-gold-lg transition-all duration-300 hover:scale-110 cursor-pointer"
        style={{
          background: isOpen
            ? 'rgba(201, 162, 52, 0.9)'
      ...
      {/* Chat Window */}
      <div
        className="fixed bottom-24 right-6 z-[100] w-[380px] max-w-[calc(100vw-48px)] transition-all duration-300"
        style={{
          opacity: isOpen ? 1 : 0,
