      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div ref={cooCardRef} className="max-w-[360px] lg:ml-auto" style={{ opacity: 0 }}>
            {/* COO photo card */}
            <div className="rounded-2xl overflow-hidden mb-6" style={{ border: '1px solid rgb(var(--color-gold) / 0.2)' }}>
            ...
            <div className="space-y-3">
              <a href="https://wa.me/60175631621" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 px-5 py-4 rounded-2xl text-kimono text-sm font-body transition-all duration-300 hover:scale-[1.02]"
                ...
                <div>
                  ...
                  <p className="text-kimono/70 text-xs">+60 17-563 1621</p>
                </div>
              </a>
              ...
              <a href="https://www.facebook.com/share/18bRc7r8cA/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer"
                ...
                <div>
                  ...
                  <p className="text-kimono/70 text-xs">Absolute Consultancy Firm</p>
                </div>
              </a>
              ...
              <a href="https://youtube.com/@absoluteconsultancy" target="_blank" rel="noopener noreferrer"
                ...
                <div>
                  ...
                  <p className="text-kimono/70 text-xs">@absoluteconsultancy</p>
                </div>
              </a>
            </div>
          </div>
