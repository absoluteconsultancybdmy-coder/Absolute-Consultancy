    ...
    >
      ...
      >
        ...
        <div className="p-6 md:p-8 lg:p-10">
          ...
          <div className="flex items-center gap-3 mt-4 pb-6" style={{ borderBottom: '1px solid rgb(var(--color-gold) / 0.18)' }}>
    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'rgb(var(--color-mist))' }}>
        ...
        >
            ...
            {HERO_DOTS.map((dot, i) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 8px rgb(var(--color-gold) / 0.5)',
                  opacity: 0,
                }}
              />
            ))}
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle at 50% 50%, rgb(var(--color-gold) / 0.08) 0%, transparent 60%)' }} />
          ...
          <div className="relative z-10 max-w-[1280px] mx-auto px-6 lg:px-10 py-16 lg:py-20 flex flex-col items-center text-center">
            ...
            >
              ...
              <span style={{
                background: 'linear-gradient(135deg, rgb(var(--color-gold)) 0%, #FFD700 50%, #D4AF37 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                filter: 'drop-shadow(0 0 24px rgb(var(--color-gold) / 0.3))',
              }}>
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 pt-14 pb-6">
          <div className="flex items-end justify-between gap-4 mb-6 flex-wrap">
            <div>
              <div className="w-12 h-px mb-4" style={{ background: 'rgb(var(--color-gold) / 0.5)' }} />
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgb(var(--color-gold) / 0.08) 0%, rgba(11,30,66,0.4) 100%)',
              border: '1.5px solid rgb(var(--color-gold) / 0.45)',
              boxShadow: '0 24px 60px rgba(0,0,0,0.35), 0 0 0 1px rgb(var(--color-gold) / 0.15)',
              opacity: 0,
            }}
          >
            <div className="absolute top-5 left-5">
              <span
                ...
                style={{ background: 'rgb(var(--color-gold))', color: '#021635', fontWeight: 700, letterSpacing: '0.18em' }}
              >
                ★ Most Popular
              </span>
            </div>
            ...
            <div className="md:pr-6">
              ...
              >
                ...
                <span style={{ color: 'rgb(var(--color-gold))' }}>Bangladesh → Malaysia</span>
              </h3>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-4">
                <button
                  ...
                  style={{ background: 'rgb(var(--color-gold))', color: '#021635', fontWeight: 700, letterSpacing: '0.16em', boxShadow: '0 8px 24px rgb(var(--color-gold) / 0.35)' }}
                >
                  Download Free PDF
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div
                  ...
                  style={{ background: 'rgba(11,26,51,0.55)', border: '1px solid rgb(var(--color-gold) / 0.2)' }}
                >
            ...
            {GUIDES.map((guide, idx) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3 mb-4">
                  ...
                  <span style={{ color: 'rgb(var(--color-gold) / 0.6)' }} className="flex-shrink-0">
                    {guide.icon}
                  </span>
                </div>
                ...
                <div className="mt-auto flex items-center justify-between pt-3" style={{ borderTop: '1px solid rgb(var(--color-gold) / 0.05)' }}>
                  <span className="font-body text-mouse flex items-center gap-1.5" style={{ fontSize: '11px' }}>
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 pb-20">
          ...
          >
            ...
            >
              Read our full <span style={{ color: 'rgb(var(--color-gold))' }}>FAQ section</span>
            </h3>
            <p
            ...
            <Link
              ...
              style={{ border: '1px solid rgb(var(--color-gold) / 0.5)', color: 'rgb(var(--color-gold))', letterSpacing: '0.16em' }}
            >
              Open FAQ
