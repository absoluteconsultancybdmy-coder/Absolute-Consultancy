...
export default function AboutSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(leftRuleRef.current,
        { scaleX: 0, transformOrigin: 'right center' },
        { scaleX: 1, duration: 1, ease: 'power2.out',
          scrollTrigger: { trigger: sectionRef.current, start: 'top 70%', toggleActions: 'play none none none' } }
      );
      gsap.fromTo(rightRuleRef.current,
        { scaleX: 0, transformOrigin: 'left center' },
        { scaleX: 1, duration: 1, ease: 'power2.out',
          scrollTrigger: { trigger: sectionRef.current, start: 'top 70%', toggleActions: 'play none none none' } }
      );
      gsap.fromTo(cooCardRef.current,
        { opacity: 0, y: 40 },
        { opacity: 1, y: 0, duration: 0.9, ease: 'power3.out',
          scrollTrigger: { trigger: cooCardRef.current, start: 'top 80%', toggleActions: 'play none none none' } }
      );
    }, sectionRef);
    ...
    <section ref={sectionRef} className="relative w-full bg-mist py-32 lg:py-40" id="about">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
        ...
        <div className="flex items-center justify-center gap-6 mb-20">
          ...
          <h2 ref={headingRef} className="font-display font-bold text-kimono text-center whitespace-nowrap"
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="relative h-[400px] lg:h-[520px] overflow-hidden">
              <img
                src="/Absolute-Consultancy/images/coo-photo.jpg"
            ...
            <div className="flex flex-col justify-center p-10 lg:p-14">
              ...
              <p className="small-caps text-gold/70 mb-3" style={{ fontSize: '11px' }}>
                Chief Operating Officer
              </p>
              <h3 className="font-display font-bold text-kimono mb-6"
              ...
              <p className="font-serif font-light text-cream/70 mb-8" style={{ fontSize: '16px', lineHeight: 1.8 }}>
                With over a decade of experience in Malaysian higher education consultancy,
              ...
              <div className="grid grid-cols-3 gap-6 mb-10">
                {[
                  ...
                  <div key={s.label}>
                    <p className="font-display font-bold text-gold" style={{ fontSize: '28px' }}>{s.value}</p>
                    <p className="font-body text-mouse text-xs uppercase tracking-wider mt-1">{s.label}</p>
                  </div>
                ))}
              </div>
        ...
        {/* ── About text ── */}
        <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
          <div className={`transition-all duration-700 ${contentInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            <p className="text-kimono/90 font-body font-light text-lg mb-8" style={{ lineHeight: 1.7 }}>
              ...
              Malaysia reach the best universities in Malaysia. Our counsellors
            ...
            <p className="text-kimono/90 font-body font-light text-lg" style={{ lineHeight: 1.7 }}>
              No need to worry about university choices, visa paperwork, or offer
              letters — everything is handled with precision and care. We'll show
              you which university fits you best and{' '}
            ...
            <div className="space-y-10">
              {[
                ...
                <div key={i} className="timeline-node relative">
                  ...
                  <p className="font-body font-light text-kimono/70 text-sm" style={{ lineHeight: 1.7 }}>{m.text}</p>
                </div>
              ))}
            </div>
          </div>
