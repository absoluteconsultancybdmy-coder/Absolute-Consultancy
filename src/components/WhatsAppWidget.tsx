...
function WhatsAppWidget() {
  ...
  useEffect(() => {
    if (!ready) return;
    const show = window.setTimeout(() => setShowDot(true), 8000);
    const hide = window.setTimeout(() => setShowDot(false), 12000);
    return () => {
    ...
    >
      ...
      <a
        ...
        style={{
          ...
          animation: reducedMotion ? undefined : 'wa-pulse 2s ease-in-out infinite',
        }}
      >
        <svg
          width="28"
