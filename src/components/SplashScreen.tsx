    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at 30% 20%, rgba(201,162,52,0.10) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(11,42,92,0.20) 0%, transparent 55%)',
          }}
        />
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div
            ...
            style={{
              ...
              height: '640px',
              background:
                'conic-gradient(from 0deg, rgba(201,162,52,0) 0%, rgba(201,162,52,0.22) 22%, rgba(201,162,52,0) 50%, rgba(11,42,92,0.22) 72%, rgba(201,162,52,0) 100%)',
              borderRadius: '50%',
              filter: 'blur(48px)',
            }}
          />
        ...
        <div className="splash-bokeh absolute inset-0 pointer-events-none" aria-hidden>
          {[
            { top: '14%', left: '18%', size: 140, dur: 9000, delay: 0, color: 'rgba(201,162,52,0.10)' },
            { top: '70%', left: '12%', size: 100, dur: 11000, delay: 1500, color: 'rgba(11,42,92,0.18)' },
            { top: '22%', left: '78%', size: 180, dur: 13000, delay: 800, color: 'rgba(201,162,52,0.09)' },
            { top: '72%', left: '82%', size: 120, dur: 10000, delay: 2200, color: 'rgba(11,42,92,0.15)' },
            { top: '46%', left: '50%', size: 90, dur: 8000, delay: 600, color: 'rgba(201,162,52,0.12)' },
          ].map((b, i) => (
            <div
              key={i}
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(115deg, transparent 30%, rgba(245,226,168,0.10) 48%, rgba(201,162,52,0.18) 50%, rgba(245,226,168,0.10) 52%, transparent 70%)',
            mixBlendMode: 'screen',
            filter: 'blur(8px)',
          }}
        />
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(201,162,52,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(201,162,52,0.04) 1px, transparent 1px)',
            ...
            return (
              <span
                ...
                style={{
                  ...
                  boxShadow: '0 0 6px rgba(201,162,52,0.5)',
          ...
          >
            <defs>
              <linearGradient id="splashGoldTL" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="50%" stopColor="#C9A234" />
        ...
        >
          ...
          >
            <h1
              ...
              style={{
                ...
                margin: 0,
                padding: '0 4px',
                background: 'linear-gradient(180deg, #F5E2A8 0%, #C9A234 50%, #8C6E1C 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
                color: 'transparent',
                filter: 'drop-shadow(0 0 28px rgba(201,162,52,0.35))',
            ...
            <div
              ...
              style={{
                ...
                background: 'linear-gradient(90deg, transparent 0%, rgba(201,162,52,0.45) 60%, rgba(201,162,52,0.7) 100%)',
                filter: 'blur(2px)',
                borderRadius: '4px',
                pointerEvents: 'none',
                opacity: 0,
            ...
            >
              <defs>
                <linearGradient id="splashLine" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#C9A234" stopOpacity="0" />
                  <stop offset="20%" stopColor="#C9A234" stopOpacity="1" />
                  <stop offset="80%" stopColor="#C9A234" stopOpacity="1" />
              ...
              <div className="splash-pen-inner">
                ...
                >
                  ...
                  >
                    ...
                    <rect x="11" y="-11" width="2.2" height="22" rx="0.6" fill="#C9A234" opacity="0.9" />
                    ...
                    <circle cx="6" cy="0" r="1.4" fill="#C9A234" opacity="0.8" />
                  ...
                  >
                    <path
                      ...
                      strokeWidth="0.6"
                    />
                    <line x1="-10" y1="0" x2="-22" y2="0" stroke="#0B1A33" strokeWidth="0.9" />
                    <circle cx="-22" cy="0" r="1.4" fill="#0B1A33" />

                    <circle
                      cx="-22"
                      cy="0"
                      r="7"
                      fill="rgba(201,162,52,0.32)"
          ...
          <div className="relative text-center px-6 mt-4">
            <p
              className="splash-tagline font-body uppercase text-cream/40"
              style={{ fontSize: 'clamp(9px, 1.1vw, 11px)', letterSpacing: '0.35em' }}
            >
              ✦ Your Journey To Malaysia ✦
            </p>
            <p
              className="splash-tagline-late font-body uppercase text-cream/30 mt-1.5"
      ...
      <style>{`
        ...
        .splash-progress {
          width: 0%;
          height: 100%;
          background: linear-gradient(90deg, transparent, #C9A234, transparent);
