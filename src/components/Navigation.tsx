    ...
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto flex items-center justify-between px-6 lg:px-10 h-20">
          ...
          {/* Links live in the overlay menu; kept here for structure only */}
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              className="hidden sm:inline-block pill-button pill-button-outline text-[11px] py-3 px-6"
            >
              Free Consultation
            </button>
            {/* Social mini-icons */}
          ...
          {/* Menu toggle — the only route to the nav links at every size */}
          <button
