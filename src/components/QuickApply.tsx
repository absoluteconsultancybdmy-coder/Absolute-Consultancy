    ...
    >
      <span
        ...
        style={{
          ...
          boxShadow:
            '0 10px 30px rgb(var(--color-gold) / 0.4), 0 0 0 1px rgb(var(--color-gold) / 0.5)',
      ...
      <style>{`
        @keyframes qa-pulse {
          0%, 100% {
            box-shadow: 0 10px 30px rgb(var(--color-gold) / 0.4), 0 0 0 1px rgb(var(--color-gold) / 0.5);
          }
          50% {
            box-shadow: 0 14px 40px rgb(var(--color-gold) / 0.6), 0 0 0 2px rgb(var(--color-gold) / 0.85);
          }
        }
      `}</style>
    </button>
